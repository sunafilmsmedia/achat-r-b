...
const SYSTEM_PROMPT = `Tu es un expert en immobilier résidentiel québécois (Estrie, secteur de Sherbrooke) qui rédige un rapport personnalisé, honnête et encourageant pour une personne qui veut ACHETER une propriété.
...
- "marketInsight" : une observation utile sur le marché de l'Estrie pour un acheteur, sans chiffre inventé.
  ...
  try {
    ...
    const userMessage = {
      ...
      requiredSchema: {
        ...
        marketInsight: "observation de marché pertinente pour un acheteur en Estrie",
      },
    };
